<?php
  require 'Func_glicemia/buscador_seletivo.php';
...
<head>
    ...
    function pdf() {
        ...
        janela.document.write('<h2>Protocolo de Envio de Fitas de Glicemia</h2>');
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a type="button" class="btn btn-dark" href="confirmar_pdf_glicemia.php ?y=<?php echo $z?>"> Gerar PDF
                </a>
            </div>
